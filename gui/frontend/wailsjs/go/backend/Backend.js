...
export function CheckUpdates() {
  return window['go']['backend']['Backend']['CheckUpdates']();
}
...
export function Error(arg1) {
  return window['go']['backend']['Backend']['Error'](arg1);
}
...
export function NextState(arg1) {
  return window['go']['backend']['Backend']['NextState'](arg1);
}
...
export function StartUpdate(arg1) {
  return window['go']['backend']['Backend']['StartUpdate'](arg1);
}

export function StopUpdate() {
  return window['go']['backend']['Backend']['StopUpdate']();
}
...
export function Update(arg1, arg2) {
  return window['go']['backend']['Backend']['Update'](arg1, arg2);
}
