...
// Source: mender (interfaces: Signer,Device,Downloader,Installer,Rebooter,LoadSaver,Callbacks,Committer)
...
func (m *MockCommitter) Commit() error {
	m.ctrl.T.Helper()
